export const meta = {
  ...
  description: "Capture deterministic parallel, pipeline, and resume behavior",
  phases: [
    { title: "setup", detail: "Reuse one call and execute the changed suffix" },
...
const parallelResult = await parallel([
  ...
  () =>
    agent("Return exactly AWSL_ORACLE_BETA_V2", {
      label: "beta-v2",
      phase: "setup",
      agentType: "oracle-no-tools",
    }),
  () =>
    agent("Return exactly AWSL_ORACLE_GAMMA", {
      label: "gamma",
      phase: "setup",
      agentType: "oracle-no-tools",
    }),
